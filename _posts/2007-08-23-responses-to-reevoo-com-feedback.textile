...
h2. Points raised by four different people

h3. I want it to be obvious when you couldn't find any products for my search query.  Currently, as no message is displayed, it's unclear whether my search didn't work or the site is broken.

This has been fixed and is now live on "reevoo.com":http://www.reevoo.com/search?q=blurgh.

h3. I question whether the google map, on the homepage, is useful.
...
h2. Points raised by three different people

h3. I like the google map.

Yay.  Actually, you should probably see the point above.

h3. I don't always have enough time to read the reviews that flash up as part of the google map.
...
h3. I find the supercategory pages (linked from the tabs at the top) hard to navigate as the categories on the left of the screen don't appear in any useful order.
...
h3. I want to be able to click the review on the homepage to see all reviews of that product.
...
h3. I want to know what order the products appear in on the search results and category pages.
...
h2. Points raised by two different people

h3. I want to understand the relationship between the overall score and the score breakdown for a product.  For example, the "Ericsson K800i":http://www.reevoo.com/reviews/mpn/ericsson/k800i is rated 9/10 yet it only scored above average in one category ('features').
...
h3. I don't really understand the score breakdown.
...
h3. I'd like to see ratings against similar products in the 'Other products like this' section.
...
h3. I'm having problems navigating the "Faq":http://www.reevoo.com/pages/faqs

Unfortunately I've never been able to replicate this problem.  Are people still experiencing it?

h3. I want to be able to filter the search results so that I'm not too overwhelmed when I search for a relatively generic term (e.g. "phone":http://www.reevoo.com/search?q=phone)
...
h3. I don't understand what the quartile link is that appears on the left hand side of a category page.

And neither do I :-)  Don't worry though, because we've removed it.

h3. I want to know why the comments on the google map don't always appear where they should.
...
h3. I want products to have a human friendly name, Canon 4000 SLR instead of Canon EOS 400D, for example.
...
h3. I want it to be obvious that the scores are out of ten.
...
h3. I want to be able to buy a product from your site.
...
h3. I'm not sure about the language of some of the commentary on the site.

Hmm, this isn't too specific so I'm not sure there's much I can say really...

h3. I prefer the selected tabs (no underline) to the unselected tabs (with an underline).
...
h3. I find it difficult to navigate the super category pages due to the long list of links down the left hand side.
...
h2. Points raised by individuals

h3. I don't like the spelling errors in the reviews.
...
h3. I don't immediately relate your "favicon":http://www.reevoo.com/images/favicon.ico to your branding.
...
h3. I want all of the same type of product to appear in the same category, e.g. "in-ear headphones":http://www.reevoo.com/browse/product_type/In+Ear and "'normal' headphones":http://www.reevoo.com/browse/product_type/Headphones should appear together.
...
h3. I couldn't find any Sony mobile phones.

I'm not sure why as they are certainly "there":http://www.reevoo.com/search?q=sony+mobile+phone now.

h3. I'm not sure that the "about us":http://www.reevoo.com/pages/about_revieworld page is professional enough.
...
h3. I find it hard to differentiate between the light blue text and the darker blue hyperlinks on certain pages, e.g. the "Faq":http://www.reevoo.com/pages/faqs
...
h3. I can't easily get back to the home page.  There's a little 'home' link in the breadcrumbs but nothing more obvious.

You can always click on the reevoo logo that appears on the top left to get back to the homepage.

h3. I want to see at a glance whether a score is an average for the product or from just one review.
...
h3. I want to know whether you round up or down and whether you use decimal points in your scores.
...
h3. I searched for something and got five pages of results.  Only four of those pages had any content.
...
h3. I'd like to be able to remove a filter independently of the rest.
...
h3. I'm able to close the balloons on the google map.
...
h3. I'd like to have a list of recently viewed products.
...
h3. I searched for "orange":http://www.reevoo.com/search?q=orange and got a "Creative Zen Micro":http://www.reevoo.com/reviews/ean/5390660094286 in my search results but couldn't understand why.
...
h3. I want people to be able to leave a review for a product.  This would be especially useful for products that currently don't have reviews.
...
h3. I want to see the list of categories (currently appearing under the search box) higher up the homepage.
...
h3. I want it to be made very clear that I can't leave a review on the site.
...
h3. I was confused by the separation of the review content from the google map, on the homepage.
...
h3. I'm not sure the plus and minus icons will be clear enough for people that need textual signposts to help them.
...
h3. I struggled to find the paging on a supercategory page, as it was hidden right at the very bottom of the page.
...
h3. I want to know how many times a review has been voted useful or useless when ordering reviews by 'useful'.

I'll add a "story":http://wikipedia.org/wiki/user_story to the development schedule and see whether it gets prioritised.

h3. I don't understand what 'elsewhere on the web' means and why it sometimes displays with nothing below it.
...
h3. I only seem to be able to filter by one facet at a time.
...
h3. I sometimes get strange results in the pricing table.  Take this "HP Cartridge":http://www.reevoo.com/reviews/mpn/hp/psc1610, that lists ten entries for 'Cartridge SAVE' all at £23.00, as an example.
...
h3. I find that the high number of anonymous reviews lessens my trust in the promise that all reviews are from genuine customers.
...
h3. I don't know for sure what the bold statements at the bottom of a review represent.  I guess they are general comments but I'm not 100% sure.
...
h3. I have to scroll down to see all of the homepage.
...
h3. I can't see the beginning of each link under the "browse all categories":http://www.reevoo.com/categories heading on the homepage.

This was identified as problem with Internet Explorer 6 and has since been fixed

h3. I always want the number of search results to appear next to the name of the product category on the supercategory page.  If the product category is too long then the number of results drops to the next line (e.g. Audio Home Systems in the "Phones and Computing":http://www.reevoo.com/browse/group/Phones+%26+Computing supercategory)
...
h3. I see the product specification panel appear below all of the reviews on some product pages.
